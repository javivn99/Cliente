...
console.log(letras);
var letras = ['A','B','C','D','E','F','G','H','I','J','K'];
letras.splice(3,0,'casa'); //Añade 'casa' después de la C. Desde la posicion 3, no elimina ninguno y añade casa en la posicion del elemento 3.
console.log(letras);
var letras = ['A','B','C','D','E','F','G','H','I','J','K'];
...
console.log(letras);
/* Esto sirve para eliminar elementos de un array. El 3 indica la posicion y el 4 los elementos a borrar desde ahi. Desde la posicion 3 elimina 4 elementos. */
...
//splice --> Quitar todos los elementos
var letras = ['A','B','C','D','E','F','G','H','I','J','K'];
...
//En una funcion cuando pones por ej; return valor >=5. Eso hace que si se cumple devuelva true.
console.log("EVERY");
